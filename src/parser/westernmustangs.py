...
class Parser():
    def __init__(self, school, base_url, category, location, conference):
        ...
        logging.info(f'Parser initialized for {school}')
    ...
    def get_coaches_url(self, *args, **kwargs):
        try:
            ...
            urls = []
            h2_tag = soup.find('h2', text="2024-25 Women's Hockey Coaching Staff") or soup.find('h2', text="2024-25 Men's Hockey Coaching Staff")
            if h2_tag:
